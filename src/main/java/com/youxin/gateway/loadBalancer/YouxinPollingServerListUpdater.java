...
public class YouxinPollingServerListUpdater implements ServerListUpdater {
    ...
    private static ScheduledThreadPoolExecutor getRefreshExecutor() {
        return YouxinPollingServerListUpdater.LazyHolder._serverListRefreshExecutor;
    }
    ...
    public YouxinPollingServerListUpdater() {
        this(LISTOFSERVERS_CACHE_UPDATE_DELAY, LISTOFSERVERS_CACHE_REPEAT_INTERVAL);
    }

    public YouxinPollingServerListUpdater(IClientConfig clientConfig) {
        this(LISTOFSERVERS_CACHE_UPDATE_DELAY, getRefreshIntervalMs(clientConfig));
    }

    public YouxinPollingServerListUpdater(final long initialDelayMs, final long refreshIntervalMs) {
